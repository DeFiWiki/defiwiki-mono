(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('uint8arrays'), require('@stablelib/sha256'), require('js-sha3'), require('elliptic'), require('@stablelib/ed25519'), require('canonicalize'), require('@stablelib/x25519'), require('@stablelib/xchacha20poly1305'), require('@stablelib/random')) :
  typeof define === 'function' && define.amd ? define(['exports', 'uint8arrays', '@stablelib/sha256', 'js-sha3', 'elliptic', '@stablelib/ed25519', 'canonicalize', '@stablelib/x25519', '@stablelib/xchacha20poly1305', '@stablelib/random'], factory) :
  (global = global || self, factory(global.didJwt = {}, global.uint8Arrays, global.sha256$1, global.jsSha3, global.elliptic, global.ed25519, global.canonicalize, global.x25519, global.xchacha20poly1305, global.random));
}(this, (function (exports, u8a, sha256$1, jsSha3, elliptic, ed25519, canonicalizeData, x25519, xchacha20poly1305, random) {
  ...
  const verifyJWT = function (jwt, options = {
    ...
    try {
      ...
      return Promise.resolve(resolveAuthenticator(options.resolver, header.alg, payload.iss || '', proofPurpose)).then(function ({
        didResolutionResult,
        authenticators,
        issuer
      }) {
